-- Criando uma função para verificar se uma tabela existe
...
-- Concedendo permissões de execução para anon e authenticated
GRANT EXECUTE ON FUNCTION check_table_exists(text) TO anon, authenticated;

-- Resto do script para criar todas as tabelas necessárias no Supabase
