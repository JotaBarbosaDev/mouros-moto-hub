...
const CalendarPage = () => {
  ...
  const filteredEvents = calendarEvents.filter(event => {
    ...
    const normalizedEventType = (event.type || '').replace('-', '_').toLowerCase();
    const normalizedFilterType = (filterType || '').replace('-', '_').toLowerCase();
        ...
        <AddEventDialog 
          ...
          onAddEvent={async (newEvent) => {
            try {
              ...
              // Chamar createEvent, que internamente vai invalidar o cache
              ...
              // Forçar uma atualização do componente após criar um evento com atraso maior
              setTimeout(() => {
                // Forçando atualização da lista de eventos com um filtro dummy
