...
const CalendarPage = () => {
  ...
  const filteredEvents = calendarEvents.filter(event => {
    ...
    const inCurrentMonth = event.startDate && isSameMonth(event.startDate, currentMonth);
  ...
  const eventsOnSelectedDate = selectedDate ? 
    filteredEvents.filter(event => event.startDate && isSameDay(event.startDate, selectedDate)) :
    [];
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <Badge 
                                className={cn(
                                  ...
                                  event.type === "solidario" ? "bg-amber-600 text-white" : "bg-purple-600 text-white"
                                )}
                              >
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    <Badge 
                      className={cn(
                        ...
                        selectedEvent.type === "solidario" ? "bg-amber-600 text-white" : "bg-purple-600 text-white"
                      )}
                    >
